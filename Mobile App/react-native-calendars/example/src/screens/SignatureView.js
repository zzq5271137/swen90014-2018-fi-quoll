...
/** This is a helper class which helps to show the view of signature
* The class SignatureView appears as an individual screen in mobile application
* Author: Yunpeng Wang
...
/** The constructor of propos of this screen component 
  ...
  constructor(props) {
    super(props);
// "visible" decides whether the signature is shown
    this.state = {
      visible: false
    };
  }
// method to show the view of signature
  show(display) {
    this.setState({visible: display});
  }

// Generate the view and style of signature 
  render() {
